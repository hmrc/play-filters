  ...
  def apply() = {
    pomExtra :=
      <url>https://www.gov.uk/government/organisations/hm-revenue-customs</url>
        ...
        <scm>
          <connection>scm:git@github.com:hmrc/play-filters.git</connection>
          <developerConnection>scm:git@github.com:hmrc/play-filters.git</developerConnection>
          <url>git@github.com:hmrc/play-filters.git</url>
        </scm>
        <developers>
          <developer>
